...
const props = defineProps<{ objects: Array<Product> }>()
...
<template>
  <div class="card">
    <PrimeDataView :value="props.objects">
      <template #list="slotProps">
        <div class="grid grid-nogutter">
          <div v-for="(item, index) in slotProps.items" :key="index" class="col-12">
            ...
            >
              <div class="md:w-5rem relative text-center">
                <svg
                  fill="#f1f5f9"
                  viewBox="0 0 100 100"
              ...
              >
                ...
                >
                  <div>
                    ...
                    <span class="text-gray-400 font-medium text-sm">{{ item.sku }}</span>
                  </div>
                </div>
                <div class="flex flex-column md:align-items-end gap-2">
                  ...
                  <span
                    ...
                    :class="item.status == 'Disponible' ? 'text-blue-400' : 'text-orange-400'"
                  >
                    {{ item.status }}
                  </span>
                </div>
